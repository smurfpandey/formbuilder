...
(function() {
  ...
  EditFieldView = (function(_super) {
    ...
    EditFieldView.prototype.addColumn = function(e) {
      var $el, columns, i, newColumn;
      $el = $(e.currentTarget);
      i = this.$el.find('.column-option').index($el.closest('.column-option'));
      columns = this.model.get(Formbuilder.options.mappings.COLUMNS) || [];
      newColumn = {
        value: ""
      };
      if (i > -1) {
      ...
      this.model.set(Formbuilder.options.mappings.COLUMNS, columns);
      this.model.trigger("change:" + Formbuilder.options.mappings.COLUMNS);
      return this.forceRender();
    };

    EditFieldView.prototype.addRow = function(e) {
      var $el, i, newRow, rows;
      $el = $(e.currentTarget);
      i = this.$el.find('.row-option').index($el.closest('.row-option'));
      rows = this.model.get(Formbuilder.options.mappings.ROWS) || [];
      newRow = {
        value: ""
      };
      if (i > -1) {
      ...
      this.model.set(Formbuilder.options.mappings.ROWS, rows);
      this.model.trigger("change:" + Formbuilder.options.mappings.ROWS);
      return this.forceRender();
    };
    ...
    EditFieldView.prototype.removeRow = function(e) {
      var $el, index, rows;
      $el = $(e.currentTarget);
      index = this.$el.find(".js-remove-row").index($el);
      rows = this.model.get(Formbuilder.options.mappings.ROWS);
      rows.splice(index, 1);
      this.model.set(Formbuilder.options.mappings.ROWS, rows);
      this.model.trigger("change:" + Formbuilder.options.mappings.ROWS);
    ...
    EditFieldView.prototype.removeColumn = function(e) {
      var $el, columns, index;
      $el = $(e.currentTarget);
      index = this.$el.find(".js-remove-column").index($el);
      columns = this.model.get(Formbuilder.options.mappings.COLUMNS);
  ...
  Formbuilder = (function() {
    ...
    Formbuilder.registerField = function(name, opts) {
      ...
      if (__indexOf.call(Formbuilder.options.DISABLED_FIELDS, name) < 0) {
    ...
    Formbuilder.config = function(options) {
      ...
      if (options.DISABLED_FIELDS != null) {
...
(function() {
  Formbuilder.registerField('grid', {
    ...
    edit: "<%= Formbuilder.templates['edit/grid']() %>",
    addButton: "<span class='symbol'><span class='fa fa-table'></span></span> Grid"
  });
...
this["Formbuilder"]["templates"]["edit/grid"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Options</div>\r\n\r\nRow\r\n<div class=\'row-option\' data-rv-each-row=\'model.' +
((__t = ( Formbuilder.options.mappings.ROWS )) == null ? '' : __t) +
'\'>\r\n  <input type="text" data-rv-input="row:value" class=\'option-label-input\' />\r\n  <a class="js-add-row ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Add Row"><i class=\'fa fa-plus-circle\'></i></a>\r\n  <a class="js-remove-row ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Remove Row"><i class=\'fa fa-minus-circle\'></i></a>\r\n</div>\r\n\r\n<div class=\'fb-bottom-add\'>\r\n  <a class="js-add-row ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'">Add Row</a>\r\n</div>\r\n\r\nColumn\r\n<div class=\'column-option\' data-rv-each-column=\'model.' +
((__t = ( Formbuilder.options.mappings.COLUMNS )) == null ? '' : __t) +
'\'>\r\n  <input type="text" data-rv-input="column:value" class=\'option-label-input\' />\r\n  <a class="js-add-column ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Add Column"><i class=\'fa fa-plus-circle\'></i></a>\r\n  <a class="js-remove-column ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Remove Column"><i class=\'fa fa-minus-circle\'></i></a>\r\n</div>\r\n\r\n<div class=\'fb-bottom-add\'>\r\n  <a class="js-add-column ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'">Add Column</a>\r\n</div>\r\n';
